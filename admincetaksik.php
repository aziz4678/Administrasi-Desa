...
<head>
	...
	<title>Cetak SIK | SI Administrasi Desa</title>
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Cetak Surat Izin Keramaian</h2>
                    ...
                    if(mysqli_num_rows($query_run) > 0)
                    {
                        ...
                        {?>
                            <tr>
                                ...
                                <td><input type="checkbox" name="id[]" value="<?php echo $admin['id_sik']; ?>"></td>
                                <td>
                                    <form action="cetaksik.php?id_sik= <?php echo $admin['id_sik'] ?>" method="post">
                                        <input type="hidden" name="id_sik">
                                        <input class="btn btn-primary btn-sm" type="submit" value="Cetak">
                                    </form>
                                    <p></p>
                                    <form action="admincetaksikhapus.php" method="post">
