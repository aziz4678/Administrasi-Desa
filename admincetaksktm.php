...
<head>
	...
	<title>Cetak SKTM | SI Administrasi Desa</title>
    ...
    <div class="d-flex bg-secondary text-white" id="wrapper">
        ...
        <div class="" id="sidebar-wrapper" style="background-color: #5a636b;">
            <div class="list-group list-group-flush my-3">
                ...
                <a href="admincetaksktm.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold active"><i class="fas fa-envelope me-2"></i>Cetak SKTM Sekolah</a>
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Cetak Surat Keterangan Tidak Mampu</h2>
                    ...
                    if(mysqli_num_rows($query_run) > 0)
                    {
                        ...
                        {?>
                            <tr>
                                ...
                                <td>
                                    <form action="cetaksktm.php?id_sktm= <?php echo $admin['id_sktm'] ?>" method="post">
                                        <input type="hidden" name="id_sktm">
                                        <input class="btn btn-primary btn-sm" type="submit" value="Cetak">
                                    </form>
                                    <p></p>
                                    <form action="admincetaksktmhapus.php" method="post">
                                    ...
                                    <p></p>
                                    <form action="upload.php?id_sktm= <?php echo $admin['id_sktm'] ?>" method="post">
                                        <input type="hidden" name="id_sktm">
