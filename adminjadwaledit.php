...
<?php
    ...
    $sql = "SELECT * FROM jadwal WHERE id_jadwal = '$jadwal'";
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-sm">
                ...
                ?>
                        <form action="" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="time" class="form-control" id="waktu_mulai" name="waktu_mulai" value="<?php echo $data['waktu_mulai'] ?>">
                            </div>
                            <div class="mb-3">
                                <label for="waktu_akhir" class="form-label">Waktu Berakhir</label>
                                <input type="time" class="form-control" id="waktu_akhir" name="waktu_akhir" value="<?php echo $data['waktu_akhir'] ?>">
                            </div>
                            <input class="btn btn-primary" type="submit" name="edit" value="Update">
                            <a class="btn btn-danger" href="adminjadwal.php" role="button">Cancel</a>
                        </form>
                <?php
                    }
                }  
                if(isset($_POST['edit'])){
                    ...
                    $sql = "UPDATE jadwal SET waktu_mulai = '$waktu_mulai', waktu_akhir = '$waktu_akhir' WHERE id_jadwal = '$jadwal'";
                    $query = $conn->query($sql);
                    if ($query) {
