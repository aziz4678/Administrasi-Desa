...
<title>Print Data Surat Keterangan Domisili</title>
...
<table width=100%>
<tr>
    <td align="center"><h3 style='margin-bottom:-5px' align=center><u>SURAT KETERANGAN DOMISILI</u> </h3></td>
</tr>
<?php
session_start();
include "koneksi.php"; 
                        ...
                        $sql = "select * from skd INNER JOIN data ON skd.id_data=data.id_data where id_skd='$_GET[id_skd]'";
                        $query = $conn->query($sql);
                        while ($admin = $query->fetch_array()) { ?> 
<tr>
    <td align="center"><p>Nomor : 00<?php echo "$admin[id_skd]"; ?>-DS-IX-2019</p></td>
</tr> 
</table>
...
<?php
                                ...
                                ?>
<p>Berdasarkan surat pengantar dari Desa Jatitengah Tanggal <?php echo date("d M Y"); ?>, bahwa benar Yang Bersangkutan adalah benar-benar warga kami dan berdomisili di Desa Jatitengah Kecamatan Selopuro Kabupaten Blitar. Demikian surat keterangan ini kami buat, untuk dipergunakan sebagaimana mestinya. </p>
<table width=100%>
  <tr>
    <td width="30%">
