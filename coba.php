...
<head>
	...
	<title>Data | SI Administrasi Desa</title>
    ...
    <div class="d-flex bg-secondary text-white" id="wrapper">
        ...
        <div class="" id="sidebar-wrapper" style="background-color: #5a636b;">
            <div class="list-group list-group-flush my-3">
                ...
                <a href="wargadata.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i class="fas fa-envelope me-2"></i>Data Warga</a>
            </div>
        </div>
        <!-- /#sidebar-wrapper -->
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-sm">
                ...
                <a class="btn btn-primary mb-2 btn-sm" href="admincetakskck.php" role="button">Back</a>
                <table class="table table-light table-striped rounded table-hover">
                    ...
                    <tbody>
                    <?php 
                    $query = "SELECT * FROM coba INNER JOIN data ON coba.id_data=data.id_data";
