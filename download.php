    ...
    <div class="d-flex bg-secondary text-white" id="wrapper">
        ...
        <div class="" id="sidebar-wrapper" style="background-color: #5a636b;">
            <div class="list-group list-group-flush my-3">
                ...
                <a href="download.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold active"><i class="fas fa-download me-2"></i>Cetak Surat Permohonan</a>
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Download Data</h2>
                    ...
                    <tbody>
                        <?php foreach ($files as $file): ?>
                            <tr>
                                ...
                                <td><a class="btn btn-primary mb-2 btn-sm" href="download.php?file_id=<?php echo $file['id'] ?>">Download</a>
