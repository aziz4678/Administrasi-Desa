    ...
    <div class="d-flex bg-secondary text-white" id="wrapper">
        ...
        <div class="" id="sidebar-wrapper" style="background-color: #5a636b;">
            <div class="list-group list-group-flush my-3">
                ...
                <a href="wargadata.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold active"><i class="fas fa-user me-2"></i>Data Warga</a>
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Data Warga</h2>
            ...
            <div class="container-sm">
                ...
                <a class="btn btn-primary mb-2 btn-sm" href="wargadatatambah.php" role="button">Tambah</a>
                    ...
                    if(mysqli_num_rows($query_run) > 0)
                    {
                        ...
                        {?>
                            <tr>
                                ...
                                <td>
                                    <form action="wargadataread.php?id_data= <?php echo $admin['id_data'] ?>" method="post">
                                        <input type="hidden" name="id_data">
                                        <input class="btn btn-warning btn-sm"  type="submit" value="Read">
                                    </form>
                                    <p></p>
                                    <form action="wargadataedit.php?id_data= <?php echo $admin['id_data'] ?>" method="post">
                                        <input type="hidden" name="id_data">
                                        <input class="btn btn-success btn-sm" type="submit" value="Update">
                                    </form>
                                    <p></p>
                                    <form action="wargadatahapus.php" method="post">
                                        <input type="hidden" name="id_data" value="<?php echo $admin['id_data'] ?>">
