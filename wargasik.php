...
<head>
	...
	<title>SIK | SI Administrasi Desa</title>
    ...
    <div class="d-flex bg-secondary text-white" id="wrapper">
        ...
        <div class="" id="sidebar-wrapper" style="background-color: #5a636b;">
            <div class="list-group list-group-flush my-3">
                ...
                <a href="wargasik.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold active"><i class="fas fa-envelope me-2"></i>Permohonan Surat Izin Keramaian</a>
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Permohonan Surat Izin Keramaian</h2>
            ...
            <div class="container-sm">
                ...
                <a class="btn btn-primary mb-2 btn-sm" href="wargasiktambah.php" role="button">Tambah</a>
                <table class="table table-light table-striped rounded table-hover">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Tanggal Keramaian</th>
                            <th scope="col">Tempat Keramaian</th>
                            <th scope="col" width="100">Aksi</th>
                        </tr>
                    </thead>
                    <tbody>
                    <?php 
                    $query = "SELECT * FROM sik INNER JOIN data ON sik.id_data=data.id_data";
                    ...
                    if(mysqli_num_rows($query_run) > 0)
                    {
                        ...
                        {?>
                            <tr>
                                <td><?php echo $admin['id_sik'] ?></td>
                                <td><?php echo $admin['nama'] ?></td>
                                <td><?php echo $admin['nik'] ?></td>
                                <td><?php echo $admin['alamat'] ?></td>
                                <td><?php echo $admin['kewarganegaraan'] ?></td>

                                <td><?php echo $admin['acara'] ?></td>
                                <td><?php echo $admin['tgll'] ?></td>
                                <td><?php echo $admin['tempp'] ?></td>
                                <td>
                                    <form action="wargasikread.php?id_sik= <?php echo $admin['id_sik'] ?>" method="post">
                                        <input type="hidden" name="id_sik">
                                        <input class="btn btn-warning btn-sm"  type="submit" value="Read">
                                    </form>
                                    <p></p>
                                    <form action="wargasikupdate.php?id_sik= <?php echo $admin['id_sik'] ?>" method="post">
                                        <input type="hidden" name="id_sik">
                                        <input class="btn btn-success btn-sm"  type="submit" value="Update">
                                    </form>
                                    <p></p>
                                    <form action="wargasikhapus.php" method="post">
                                        <input type="hidden" name="id_sik" value="<?php echo $admin['id_sik'] ?>">
