...
<head>
    ...
    <title>SIK Read | SI Administrasi Desa</title>
            ...
            <div class="card-body table-responsive">
                ...
                ?>
                    <tr>
                            ...
                            <tr>
                                <th style="width: 40%">Tanggal Keramaian</th>
                                <td><?php echo $data['tgll'] ?></td>
                            </tr>
                            <tr>
                                <th style="width: 40%">Tempat Keramaian</th>
                                <td><?php echo $data['tempp'] ?></td>
                            </tr>
