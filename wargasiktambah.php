...
<head>
	...
	<title>SIK Tambah | SI Administrasi Desa</title>
    ...
    <div class="d-flex bg-secondary text-white" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-sm">
                ...
                <form action="wargasiktambahaksi.php" method="post">
                    <div class="mb-3">
                        <label for="id_sik" class="form-label">Id </label>
                        <input type="text" class="form-control" id="id_sik" name="id_sik">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="temp" name="tempp">
                    </div>
