...
<head>
	...
	<title>SKCK | SI Administrasi Desa</title>
    ...
    <div class="d-flex bg-secondary text-white" id="wrapper">
        ...
        <div class="" id="sidebar-wrapper" style="background-color: #5a636b;">
            <div class="list-group list-group-flush my-3">
                ...
                <a href="wargaskck.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold active"><i class="fas fa-envelope me-2"></i>Permohonan SKCK</a>
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Permohonan Surat Keterangan Catatan Kepolisian</h2>
            ...
            <div class="container-sm">
                ...
                <a class="btn btn-primary mb-2 btn-sm" href="wargaskcktambah.php" role="button">Tambah</a>
                <table class="table table-light table-striped rounded table-hover">
                    ...
                    <tbody>
                    <?php 
                    $query = "SELECT * FROM skck INNER JOIN data ON skck.id_data=data.id_data";
                    ...
                    if(mysqli_num_rows($query_run) > 0)
                    {
                        ...
                        {?>
                            <tr>
                                ...
                                <td>
                                    <form action="wargaskckread.php?id_skck= <?php echo $admin['id_skck'] ?>" method="post">
                                        <input type="hidden" name="id_skck">
                                        <input class="btn btn-warning btn-sm"  type="submit" value="Read">
                                    </form>
                                    <p></p>
                                    <form action="wargaskckupdate.php?id_skck= <?php echo $admin['id_skck'] ?>" method="post">
                                        <input type="hidden" name="id_skck">
                                        <input class="btn btn-success btn-sm"  type="submit" value="Update">
                                    </form>
                                    <p></p>
                                    <form action="wargaskckhapus.php" method="post">
                                        <input type="hidden" name="id_skck" value="<?php echo $admin['id_skck'] ?>">
