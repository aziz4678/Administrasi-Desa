...
<head>
	...
	<title>SKCK Tambah| SI Administrasi Desa</title>
    ...
    <div class="d-flex bg-secondary text-white" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-sm">
                ...
                <form action="wargaskcktambahaksi.php" method="post">
                    <div class="mb-3">
                        <label for="id_skck" class="form-label">Id SKCK</label>
                        <input type="text" class="form-control" id="id_skck" name="id_skck">
                    </div>
                    <div class="mb-3">
