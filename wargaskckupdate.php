...
<head>
    ...
    <title>SKCK Edit | SI Administrasi Desa</title>
...
<body>
    ...
    include "koneksi.php";
    $dataa = $_GET['id_skck'];
    $sql = "SELECT * FROM skck INNER JOIN data ON skck.id_data=data.id_data WHERE id_skck = '$dataa'";
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-sm">
                ...
                if(isset($_POST['edit'])){
                    $dataa = $_GET['id_skck'];
                    $nama = $_POST['id_data'];
                    $sql = "UPDATE skck SET id_data = '$nama'";
                    $query = $conn->query($sql);
                    if ($query) {
