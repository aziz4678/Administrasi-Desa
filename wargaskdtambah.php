...
<head>
	...
	<title>SKD Tambah | SI Administrasi Desa</title>
    ...
    <div class="d-flex bg-secondary text-white" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-sm">
                ...
                <form action="wargaskdtambahaksi.php" method="post">
                    <div class="mb-3">
                        <label for="id_skd" class="form-label">Id skd</label>
                        <input type="text" class="form-control" id="id_skd" name="id_skd">
                    </div>
                    <div class="mb-3">
