...
<head>
    ...
    <title>SKD Edit | SI Administrasi Desa</title>
...
<body>
    ...
    include "koneksi.php";
    $dataa = $_GET['id_skd'];
    $sql = "SELECT * FROM skd INNER JOIN data ON skd.id_data=data.id_data WHERE id_skd = '$dataa'";
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-sm">
                ...
                if(isset($_POST['edit'])){
                    $dataa = $_GET['id_skd'];
                    $nama = $_POST['id_data'];
                    $sql = "UPDATE skd SET id_data = '$nama'";
                    $query = $conn->query($sql);
                    if ($query) {
