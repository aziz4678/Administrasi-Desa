...
<head>
	...
	<title>SKTM | SI Administrasi Desa</title>
    ...
    <div class="d-flex bg-secondary text-white" id="wrapper">
        ...
        <div class="" id="sidebar-wrapper" style="background-color: #5a636b;">
            <div class="list-group list-group-flush my-3">
                ...
                <a href="wargasktm.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold active"><i class="fas fa-envelope me-2"></i>Permohonan SKTM Sekolah</a>
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Permohonan Surat Keterangan Tidak Mampu</h2>
            ...
            <div class="container-sm">
                ...
                <a class="btn btn-primary mb-2 btn-sm" href="wargasktmtambah.php" role="button">Tambah</a>
                ...
                <table class="table table-light table-striped rounded table-hover">
                    ...
                    <tbody>
                    <?php 
                    $query = "SELECT * FROM sktm INNER JOIN data ON sktm.id_data=data.id_data";
                    ...
                    if(mysqli_num_rows($query_run) > 0)
                    {
                        ...
                        {?>
                            <tr>
                                ...
                                <td><?php echo $admin['namaa'] ?></td>
                                <td><?php echo $admin['nis'] ?></td>
                                <td><?php echo $admin['sekolah'] ?></td>
                                <td>
                                    <form action="wargasktmread.php?id_sktm= <?php echo $admin['id_sktm'] ?>" method="post">
                                        <input type="hidden" name="id_sktm">
                                        <input class="btn btn-warning btn-sm"  type="submit" value="Read">
                                    </form>
                                    <p></p>
                                    <form action="wargasktmupdate.php?id_sktm= <?php echo $admin['id_sktm'] ?>" method="post">
                                        <input type="hidden" name="id_sktm">
                                        <input class="btn btn-success btn-sm"  type="submit" value="Update">
                                    </form>
                                    <p></p>
                                    <form action="wargasktmhapus.php" method="post">
                                        <input type="hidden" name="id_sktm" value="<?php echo $admin['id_sktm'] ?>">
