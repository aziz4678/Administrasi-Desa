...
<head>
    ...
    <title>SKTM Edit | SI Administrasi Desa</title>
...
<body>
    ...
    include "koneksi.php";
    $dataa = $_GET['id_sktm'];
    $sql = "SELECT * FROM sktm INNER JOIN data ON sktm.id_data=data.id_data WHERE id_sktm = '$dataa'";
            ...
            <div class="container-sm">
                ...
                ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="namaa" name="namaa" value="<?php echo $data['namaa'] ?>">
                    </div>
                    <div class="mb-3">
                        <label for="nis" class="form-label">NIS</label>
                        <input class="form-control" id="nis" name="nis" value="<?php echo $data['nis'] ?>">
                    </div>
                    <div class="mb-3">
                        <label for="sekolah" class="form-label">Nama Sekolah</label>
                        <input class="form-control" id="sekolah" name="sekolah" value="<?php echo $data['sekolah'] ?>">
                    </div> 
                ...
                if(isset($_POST['edit'])){
                    ...
                    $jenis = $_POST['nis'];
                    $temp = $_POST['sekolah'];
                    $sql = "UPDATE sktm SET id_data = '$nama', namaa = '$nik', nis = '$jenis', sekolah = '$temp'";
                    $query = $conn->query($sql);
                    if ($query) {
