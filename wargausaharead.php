...
<head>
    ...
    <title>SKU Read | SI Administrasi Desa</title>
            ...
            <div class="card-body table-responsive">
                ...
                ?>
                    <tr>
                            ...
                            <tr>
                                <th style="width: 40%">Nama Usaha</th>
                                <td><?php echo $data['usaha'] ?></td>
                            </tr>
                            <tr>
                                <th style="width: 40%">Deskripsi Usaha</th>
                                <td><?php echo $data['deskripsi'] ?></td>
                            </tr>
                            <tr>
                                <th style="width: 40%">Alamat Usaha</th>
