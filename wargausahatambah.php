...
<head>
	...
	<title>SKU Tambah | SI Administrasi Desa</title>
    ...
    <div class="d-flex bg-secondary text-white" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-sm">
                ...
                <form action="wargausahatambahaksi.php" method="post">
                    <div class="mb-3">
                        <label for="id_sktm" class="form-label">Id Usaha</label>
                        <input type="text" class="form-control" id="id_usaha" name="id_usaha">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" id="usaha" name="usaha">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" id="sejak" name="sejak">
                    </div>
                    <div class="mb-3">
                        <label for="al" class="form-label">Alamat Usaha</label>
                        <input class="form-control" id="al" name="al">
                    </div>                      
